...
public class ImageScanUtils {
   private static final String TAG = ImageScanUtils.class.getSimpleName();
    ...
    public static Bitmap enhanceScan(Bitmap image, Point topLeft, Point topRight, Point bottomLeft, Point bottomRight) {
