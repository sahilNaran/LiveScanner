...
public class CameraViewCanvasOverlay extends View {
    private final ArrayList<ScanShape> shapes = new ArrayList<>();

    public CameraViewCanvasOverlay(Context context) {
        super(context);
    }

    public CameraViewCanvasOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CameraViewCanvasOverlay(Context context, AttributeSet attrs, int defStyle) {
