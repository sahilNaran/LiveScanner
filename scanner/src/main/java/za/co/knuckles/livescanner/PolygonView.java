...
public class PolygonView extends FrameLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        bgPaint.setColor(getResources().getColor(R.color.colorBlackFortyPercentAlpha));
        ...
        int radius = ImageScanUtils.dp2px(context, 11);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_DOWN:
                    LiveScanActivity.allDraggedPointsStack.push(new PolygonPoints(new PointF(pointer1.getX(), pointer1.getY()),
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (isValidShape(getPoints()) && isValidPointer1() && isValidPointer2() && isValidPointer3() && isValidPointer4()) {
                        ...
                        LiveScanActivity.allDraggedPointsStack.pop();
                        color = getResources().getColor(R.color.crop_color);
